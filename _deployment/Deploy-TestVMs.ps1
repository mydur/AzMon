...
$Location = "westeurope"
$VMNames = "azmonvmprod11", "azmonvmprod15"

az network vnet create --resource-group "$ResourceGroupName" --location "$Location" --name "azmonvm-prod-vnet" --address-prefix 10.10.101.0/24 --subnet-name "azmonvm-prod-vnet-sub1" --subnet-prefix 10.10.101.0/25
